...
# # 输入和输出文件夹路径
# input_folder = r"/Users/wangye/wangyePHD.github.io/projects/omnistyle/1800-tower/temp"
...
# 替换为你的图像根目录
img_dir = "/Users/wangye/wangyePHD.github.io/projects/omnistyle/1800-tower/processed_indoor"
...
for filename in sorted(os.listdir(img_dir)):
    if filename.lower().endswith((".png", ".jpg", ".jpeg")):
        relative_path = f"omnistyle/1800-tower/processed_indoor/{filename}"
